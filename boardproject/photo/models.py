...
class Photo(models.Model):
    ...
    image_thumbnail = ImageSpecField(source = 'image2', processors = [ResizeToFill(300, 300)])
    image_thumbnail = ImageSpecField(source = 'image3', processors = [ResizeToFill(300, 300)])
